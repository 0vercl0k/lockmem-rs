...
as_u32! {
    ...
    PROCESS_SET_QUOTA, PROCESS_QUERY_INFORMATION, PROCESS_VM_OPERATION, PROCESS_VM_READ, TOKEN_QUERY,
    MEM_FREE, MEM_RESERVE, PAGE_GUARD, PAGE_NOACCESS, ENABLE_VIRTUAL_TERMINAL_PROCESSING
}
