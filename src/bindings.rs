...
as_u32! {
    ...
    MEM_FREE, MEM_RESERVE, PAGE_GUARD, PAGE_NOACCESS, ENABLE_VIRTUAL_TERMINAL_PROCESSING, TOKEN_ADJUST_PRIVILEGES, SE_PRIVILEGE_ENABLED, ERROR_NOT_ALL_ASSIGNED, ERROR_NO_MORE_FILES
}
